...
| Restart quorum and peer mismatch | `test_restarting_workers_release_barrier_only_after_restart_quorum`, `test_restart_worker_with_peer_count_mismatch_is_rejected` | multi-peer restart specs such as `dmtcp5`, `sched_test`, and `shared-fd1` exercise quorum success; mismatch rejection is not covered | Partially real-worker-backed |
