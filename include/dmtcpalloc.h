...
//
// Copyright (c) 2002 Pete Isensee (PKIsensee@msn.com).
...
public:
  ...
  DmtcpAlloc &operator=(const DmtcpAlloc &) { return *this; }
  // Destructor
  ~DmtcpAlloc() throw() {}
  // Utility functions
...
typedef std::basic_string<char, std::char_traits<char>, DmtcpAlloc<char> >
  string;
typedef std::basic_stringstream<char, std::char_traits<char>, DmtcpAlloc<char> >
  stringstream;
