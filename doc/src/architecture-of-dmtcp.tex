...
\STATE {\tt LD\_PRELOAD=libdmtcp.so a.out}
\end{algorithmic}
...
independent copmutations, and independently checkpoint them.  If the user
...
with DMTCP.  {\em For thos who wished to use the prior MTCP arhitecture
...
and writing your own, see {\tt doc/plugin-tuorial.pdf}~.
