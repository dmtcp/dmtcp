...
#define ENV_VAR_ALLOW_OVERWRITE_WITH_CKPTED_FILES "DMTCP_ALLOW_OVERWRITE_WITH_CKPTED_FILES"
#define ENV_VAR_PLUGIN "DMTCP_PLUGIN"
#define ENV_VAR_PLUGIN_32 "DMTCP_PLUGIN_32"
...
#define ENV_VAR_TID_OFFSET "DMTCP_TID_OFFSET"
