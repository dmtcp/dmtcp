...
#define UNINITIALIZED_PORT              \
  -1 /* used with getCoordHostAndPort() \
        */
...
#define ENV_VARS_ALL                                                       \
  ENV_VAR_NAME_HOST, ENV_VAR_NAME_PORT, ENV_VAR_CKPT_INTR,                 \
    ...
    ENV_VAR_CKPT_OPEN_FILES, ENV_VAR_QUIET, ENV_VAR_STDERR_PATH,           \
    ENV_VAR_COMPRESSION, ENV_VAR_ALLOC_PLUGIN, ENV_VAR_DL_PLUGIN,          \
    ENV_VAR_SIGCKPT, ENV_VAR_SCREENDIR, ENV_VAR_DLSYM_OFFSET,              \
    ENV_VAR_DLSYM_OFFSET_M32, ENV_VAR_VIRTUAL_PID,                         \
    ENV_VAR_SKIP_WRITING_TEXT_SEGMENTS, ENV_DELTACOMPRESSION
