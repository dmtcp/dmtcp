...
#define RESTOREARGS_6     \
  ...
  "movl %4, %%esp\n\t" RESTOREARGS_5
#define ASMFMT_6(arg1, arg2, arg3, arg4, arg5, arg6)                  \
  , "0"(arg1), "m"(_xv1), "m"(_xv2), "c"(arg2), "d"(arg3), "S"(arg4), \
    "D"(arg5), "rm"(arg6)
#else // if 0
...
*/
#define ASMFMT_6(arg1, arg2, arg3, arg4, arg5, arg6) \
  , "0"(arg1), "c"(arg2), "d"(arg3), "S"(arg4), "D"(arg5), "rm"(arg6)
#endif // if 0
...
#define __set_errno(Val)                                \
  (mtcp_sys_errno = (Val)) /* required for sysdep-XXX.h \
                              */
...
#define mtcp_sys_unlink(path) \
  mtcp_inline_syscall(unlinkat, 3, AT_FDCWD, path, 0)
#else // if defined(__aarch64__)
...
#define mtcp_sys_gettimeofday(args...) \
  mtcp_inline_syscall(gettimeofday, 2, args)
...
#define mtcp_sys_mmap(addr, length, prot, flags, fd, offset)           \
  (void *)mtcp_inline_syscall(mmap2, 6, addr, length, prot, flags, fd, \
                              offset / 4096)
#elif defined(__aarch64__)
#define mtcp_sys_mmap(args...) (void *)mtcp_inline_syscall(mmap, 6, args)
...
#define mtcp_sys_rt_sigaction(args...) \
  mtcp_inline_syscall(rt_sigaction, 4, args)
...
#define INLINE_SYSCALL_RAW(name, nr, ...) mtcp_syscall(name, ##__VA_ARGS__)
