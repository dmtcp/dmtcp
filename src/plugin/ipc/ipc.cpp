...
DmtcpPluginDescriptor_t sshPlugin = {DMTCP_PLUGIN_API_VERSION,
                                     PACKAGE_VERSION,
                                     "ssh",
                                     "DMTCP",
                                     "dmtcp@ccs.neu.edu",
...
DmtcpPluginDescriptor_t filePlugin = {DMTCP_PLUGIN_API_VERSION,
                                      PACKAGE_VERSION,
                                      "file",
                                      "DMTCP",
                                      "dmtcp@ccs.neu.edu",
...
DmtcpPluginDescriptor_t ptyPlugin = {DMTCP_PLUGIN_API_VERSION,
                                     PACKAGE_VERSION,
                                     "file",
                                     "DMTCP",
                                     "dmtcp@ccs.neu.edu",
...
DmtcpPluginDescriptor_t socketPlugin = {DMTCP_PLUGIN_API_VERSION,
                                        PACKAGE_VERSION,
                                        "socket",
                                        "DMTCP",
                                        "dmtcp@ccs.neu.edu",
...
DmtcpPluginDescriptor_t eventPlugin = {DMTCP_PLUGIN_API_VERSION,
                                       PACKAGE_VERSION,
                                       "event",
                                       "DMTCP",
                                       "dmtcp@ccs.neu.edu",
...
DmtcpPluginDescriptor_t ipcPlugin = {DMTCP_PLUGIN_API_VERSION,
                                     PACKAGE_VERSION,
                                     "ipc",
                                     "DMTCP",
                                     "dmtcp@ccs.neu.edu",
