...
#define OSHIFTPRINTF(name) case name: o << # name; break;
    ...
    OSHIFTPRINTF(DMT_KVDB64_GET)
    OSHIFTPRINTF(DMT_KVDB64_GET_RESPONSE)
    OSHIFTPRINTF(DMT_KVDB64_GET_FAILED)
    OSHIFTPRINTF(DMT_KVDB64_OP)
    OSHIFTPRINTF(DMT_KVDB64_OP_RESPONSE)
