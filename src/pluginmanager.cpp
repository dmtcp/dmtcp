...
// Plugin state is initialized during early loader/plugin setup before user
// threads run.  dmtcp_initialize_plugin() then primes wrapper-level caches, so
// later wrapper calls do not need a pthread_once-style guarded initializer.
