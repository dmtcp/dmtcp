...
torque_home_nodefile(char *ptr)
{
  ...
  JTRACE("Looks like we can grap PBS_HOME from PBS_NODEFILE")
  (nodefile)(file_start)(aux_start)(aux_name);
         ...
         tm_event_t *event)
{
  ...
  ret = Util::expandPathname(ckptCmdPath.c_str(), dmtcpCkptPath,
                             sizeof(dmtcpCkptPath));
