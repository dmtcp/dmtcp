...
PMI_Finalize(void)
{
  ...
  if (!_real) {
    ...
    _kvsname_max = (_PMI_KVS_Get_name_length_max_t)dlsym(
      handle, "PMI_KVS_Get_name_length_max");
    _key_max = (_PMI_KVS_Get_key_length_max_t)dlsym(
      handle, "PMI_KVS_Get_key_length_max");
    _val_max = (_PMI_KVS_Get_value_length_max_t)dlsym(
      handle, "PMI_KVS_Get_value_length_max");
  }
